...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Define SQL queries based on the selected usertype
        ...
        $sql = "SELECT * FROM admin_login_table WHERE username = '$username' AND password1 = '$password'";
        $dashboardPage = "http://localhost/DIY_Project_sharing_platform/php/admin_dashboard.php";
